package io.microservices.zuul.filter;
...
public class ZuulLoggingPostFilter extends ZuulFilter  
	...
	logger.info("after request executed -> {} request uri-> {}", request, request.getRequestURI());  
	return null;  
	}  
	...
	{  
	return "post"; //intercept all the request after execution  
	}
